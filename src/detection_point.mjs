...
let physicalBody;
let visualBody; 
function createHoldInPlaceBox(x, y, z, width, height, depth,score) {
       // the visible side - THREE.JS
    var geometry = new THREE.BoxGeometry(width, height, depth);
    var material = new THREE.MeshBasicMaterial({ color: 0xff0000 }); // this material has no shadows and reflections and more basic colour-red
...
export { createHoldInPlaceBox, physicalBody, visualBody };